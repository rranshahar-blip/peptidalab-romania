...
// PeptidaLab catalog vial imagery — approved product-specific mockups (2026-09-01)
(function applyCatalogVialSprite(){
  const catalog=$('#product-grid');
  if(!catalog)return;
  const frames={
    'retatrutide-10mg-vial-premium.png':[0,0],
    'retatrutide-20mg-vial-premium.png':[25,0],
    'mots-c-10mg-vial-premium.png':[50,0],
    'nad-plus-500mg-vial-premium.png':[75,0],
    'nad-plus-1000mg-vial-premium.png':[100,0],
    'ss-31-elamipretide-10mg-vial-premium.png':[0,25],
    'tesamorelin-10mg-vial-premium.png':[25,25],
    'hgh-fragment-176-191-5mg-vial-premium.png':[50,25],
    'skin-glow-ghk-cu-50mg-vial-premium.png':[75,25],
    'skin-glow-ghk-cu-100mg-vial-premium.png':[100,25],
    'bpc-157-5mg-vial-premium.png':[0,50],
    'bpc-157-10mg-vial-premium.png':[25,50],
    'tb-500-5mg-vial-premium.png':[50,50],
    'tb-500-10mg-vial-premium.png':[75,50],
    'glow-bpc-ghk-cu-tb-500-vial-premium.png':[100,50],
    'klow-bpc-ghk-cu-tb-500-kpv-vial-premium.png':[0,75],
    'cjc-1295-no-dac-10mg-vial-premium.png':[25,75],
    'ipamorelin-10mg-vial-premium.png':[50,75],
    'hgh-somatropin-10iu-vial-premium.png':[75,75],
    'igf-1-lr3-1mg-vial-premium.png':[100,75],
    'pt-141-10mg-vial-premium.png':[0,100],
    'ac-semax-nh2-10mg-vial-premium.png':[25,100],
    'ac-selank-nh2-10mg-vial-premium.png':[50,100],
    'dsip-10mg-vial-premium.png':[75,100],
    'bacteriostatic-water-3ml-vial-premium.png':[100,100]
  };
  $$('.product-card',catalog).forEach(card=>{
    const img=$('.vial-image',card),visual=$('.product-visual',card);
    if(!img||!visual)return;
    const file=(img.getAttribute('src')||'').split('/').pop().split('?')[0];
    const pos=frames[file];
    if(!pos)return;
    Object.assign(visual.style,{
      backgroundImage:"url('/assets/products/catalog-vials-20260901.png?v=20260901-1')",
    ...
    Object.assign(img.style,{opacity:'0',width:'100%',height:'100%',maxWidth:'100%',margin:'0'});
  });
})();
